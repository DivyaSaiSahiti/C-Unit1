...
namespace spec
{
	...
	public:
		...
		void Test_SignificantBytes()
		{
            ...
            Assert::AreEqual(0x00, leastSignificantByte(0), L"leastSignificantByte(0) failed", 1, 2);
            Assert::AreEqual(0x00, mostSignificantByte(0), L"mostSignificantByte(0) failed", 1, 2);
		};
